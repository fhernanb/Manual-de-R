...
```{block2, type='rmdnote'}
Para recuperar el valor almacenado en la fila `f` y columna `c` dentro una matriz se usan corchetes `[f, c]` y dentro el número de fila y número de columna que nos interesan.
```
