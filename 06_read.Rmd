...
```{block2, type='rmdwarning'}
La instalación del paquete con `install.packages` se hace sólo una vez y no más. Cargar el paquete con `library` en la sesión se debe hacer siempre que se vaya a usar el paquete.
```
