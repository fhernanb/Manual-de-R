...
```{block2, type='rmdnote'}
En este ejemplo no verificamos que la muestra aleatoria de alturas proviene de una población normal poruq eso ya lo habíamos hecho en el primer ejemplo de la sección \@ref(ICDifMed).
