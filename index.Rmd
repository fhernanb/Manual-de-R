...
Este libro fue creado con la intención de apoyar el aprendizaje del programa \proglang{R} en estudiantes de cualquier pregrado, especialización, maestría e investigadores que necesiten realizar análisis estadísticos. El objetivo de este libro es mostrar la forma de realizar diversos análisis estadísticos, las cuestiones sobre la creación de gráficos estadísticos no son abordadas en el presente libro, para consultar sobre gráficos recomendamos consultar @correa_hernandez.
