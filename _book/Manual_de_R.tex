...
En la Figura \ref{fig:loglik2} se muestra el gráfico de contornos o de
calor para la superficie de log-verosimilitud. De esta figura se nota
claramente que los valores que maximizan la superficie están alrededor
de \(\mu=170\) y \(\sigma=5\). Para ver el código usado en la creación
de la Figura \ref{fig:loglik2} se recomienda consultar la sección sobre
\texttt{contour} en \citet{correa_hernandez}.

\begin{figure}[htbp]
\centering
\includegraphics{Manual_de_R_files/figure-latex/loglik2-1.pdf}
\caption{\label{fig:loglik2}Mapa de calor para la función de
...
\begin{figure}[htbp]
\centering
\includegraphics{Manual_de_R_files/figure-latex/unnamed-chunk-224-1.pdf}
\caption{\label{fig:unnamed-chunk-224}Perfil de la función f(x).}
\end{figure}
