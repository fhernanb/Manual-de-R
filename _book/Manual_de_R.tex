...
\item
  ...
  estudiante de la universidad, use la función read.table para leer la
  base de datos.
\end{enumerate}
...
\begin{figure}[htbp]
\centering
\includegraphics{Manual_de_R_files/figure-latex/unnamed-chunk-118-1.pdf}
\caption{\label{fig:unnamed-chunk-118}Perfil de la función f(x).}
\end{figure}
