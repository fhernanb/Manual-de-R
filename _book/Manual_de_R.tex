...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{subset}\NormalTok{(mimarco, }\DataTypeTok{subset=}\NormalTok{edad }\OperatorTok{>=}\StringTok{ }\OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
los tiempos iguales o diferentes? Usar \(\alpha=0.03\).
...
\(\alpha\) de significancia 3\%, se puede concluir que las varianzas son
similares.
