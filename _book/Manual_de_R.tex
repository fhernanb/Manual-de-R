...
\BeginKnitrBlock{rmdnote}
Para recuperar el valor almacenado dentro un vector se usan corchetes
\texttt{{[}{]}} y dentro la posición o posiciones que interesan.
\EndKnitrBlock{rmdnote}
...
\BeginKnitrBlock{rmdnote}
Para recuperar el valor almacenado en la fila \texttt{f} y columna
\texttt{c} de una matriz se usan corchetes \texttt{{[}f,\ c{]}} y dentro
el número de fila y número de columna que nos interesan.
\EndKnitrBlock{rmdnote}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mimatriz[, -}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{, }\DecValTok{4}\NormalTok{)]  }\CommentTok{# Las columnas de interes se indican como vector}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mimatriz[-}\DecValTok{1}\NormalTok{, -}\DecValTok{3}\NormalTok{]  }\CommentTok{# Las columnas de NO interese se indican como vector}
\end{Highlighting}
\end{Shaded}
...
\BeginKnitrBlock{rmdnote}
Para recuperar valores almacenados en un arreglo se usan también
corchetes y dentro las coordenadas del objeto de interés.
\EndKnitrBlock{rmdnote}
...
\BeginKnitrBlock{rmdnote}
Para recuperar las variables almacenadas en un marco de datos se puede
usar el operador \texttt{\$} o corchetes \texttt{{[}{]}}.
\EndKnitrBlock{rmdnote}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mimarco$deporte  }\CommentTok{# Util si el nombre es corto}
\end{Highlighting}
\end{Shaded}
...
Otra forma de recuperar la variable edad es indicando la columna donde
se encuentra la variable

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mimarco[, }\DecValTok{2}\NormalTok{]  }\CommentTok{# Util si recordamos su ubicacion}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}[htbp]
\centering
\includegraphics{Manual_de_R_files/figure-latex/unnamed-chunk-153-1.pdf}
\caption{\label{fig:unnamed-chunk-153}Perfil de la función f(x).}
\end{figure}
