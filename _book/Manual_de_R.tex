...
\begin{verbatim}
## Warning in densfun(x, parm[1], parm[2], ...): NaNs
## produced
\end{verbatim}
...
\begin{figure}[htbp]
\centering
\includegraphics{Manual_de_R_files/figure-latex/unnamed-chunk-231-1.pdf}
\caption{\label{fig:unnamed-chunk-231}Perfil de la función f(x).}
\end{figure}
