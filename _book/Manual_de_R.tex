...
\texttt{subset(x,\ subset,\ select)}.
\EndKnitrBlock{rmdnote} \index{subset}
...
\begin{figure}[htbp]
\centering
\includegraphics{Manual_de_R_files/figure-latex/unnamed-chunk-159-1.pdf}
\caption{\label{fig:unnamed-chunk-159}Perfil de la función f(x).}
\end{figure}
