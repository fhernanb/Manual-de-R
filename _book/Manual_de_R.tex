...
\NormalTok{x1 <-}\StringTok{ }\KeywordTok{runif}\NormalTok{(}\DataTypeTok{n=}\NormalTok{n, -}\DecValTok{5}\NormalTok{, }\DecValTok{6}\NormalTok{)}
\NormalTok{y <-}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(}\DataTypeTok{n=}\NormalTok{n, }\DataTypeTok{mean=}\NormalTok{-}\DecValTok{2} \NormalTok{+}\StringTok{ }\DecValTok{3} \NormalTok{*}\StringTok{ }\NormalTok{x1, }\DataTypeTok{sd=}\DecValTok{5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{minusll <-}\StringTok{ }\NormalTok{function(theta, y, x1) \{}
  \NormalTok{media <-}\StringTok{ }\NormalTok{theta[}\DecValTok{1}\NormalTok{] +}\StringTok{ }\NormalTok{theta[}\DecValTok{2}\NormalTok{] *}\StringTok{ }\NormalTok{x1  }\CommentTok{# Se define la media}
  \NormalTok{desvi <-}\StringTok{ }\NormalTok{theta[}\DecValTok{3}\NormalTok{]                  }\CommentTok{# Se define la desviación.}
  \NormalTok{-}\StringTok{ }\KeywordTok{sum}\NormalTok{(}\KeywordTok{dnorm}\NormalTok{(}\DataTypeTok{x=}\NormalTok{y, }\DataTypeTok{mean=}\NormalTok{media, }\DataTypeTok{sd=}\NormalTok{desvi, }\DataTypeTok{log=}\OtherTok{TRUE}\NormalTok{))}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{res <-}\StringTok{ }\KeywordTok{optim}\NormalTok{(}\DataTypeTok{par=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{), }\DataTypeTok{fn=}\NormalTok{minusll,}
             \DataTypeTok{method=}\StringTok{'L-BFGS-B'}\NormalTok{,}
             \DataTypeTok{lower=}\KeywordTok{c}\NormalTok{(-}\OtherTok{Inf}\NormalTok{, -}\OtherTok{Inf}\NormalTok{, }\DecValTok{0}\NormalTok{),}
...
En el objeto \texttt{res} está el resultado de la optimización, para
...
\KeywordTok{t.test}\NormalTok{(x, }\DataTypeTok{alternative =} \StringTok{"greater"}\NormalTok{, }\DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{)$conf.int}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{res <-}\StringTok{ }\KeywordTok{Var.test}\NormalTok{(}\DataTypeTok{x=}\NormalTok{hombres$altura, }\DataTypeTok{conf.level=}\FloatTok{0.98}\NormalTok{)}
\NormalTok{res$conf.int}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{var.test}\NormalTok{(}\DataTypeTok{x=}\NormalTok{hombres$altura, }\DataTypeTok{y=}\NormalTok{mujeres$altura,}
         \DataTypeTok{conf.level=}\FloatTok{0.95}\NormalTok{)$conf.int}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{prop.test}\NormalTok{(}\DataTypeTok{x=}\DecValTok{275}\NormalTok{, }\DataTypeTok{n=}\DecValTok{500}\NormalTok{, }\DataTypeTok{conf.level=}\FloatTok{0.90}\NormalTok{)$conf.int}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{prop.test}\NormalTok{(}\DataTypeTok{x=}\KeywordTok{c}\NormalTok{(}\DecValTok{75}\NormalTok{, }\DecValTok{80}\NormalTok{), }\DataTypeTok{n=}\KeywordTok{c}\NormalTok{(}\DecValTok{1500}\NormalTok{, }\DecValTok{2000}\NormalTok{), }\DataTypeTok{conf.level=}\FloatTok{0.90}\NormalTok{)$conf.int}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{lillie.test}\NormalTok{(T1)$p.value}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{lillie.test}\NormalTok{(T2)$p.value}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{require}\NormalTok{(nortest)  }\CommentTok{# Se debe tener instalado}
\KeywordTok{lillie.test}\NormalTok{(urb)$p.value}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{lillie.test}\NormalTok{(rur)$p.value}
\end{Highlighting}
\end{Shaded}
