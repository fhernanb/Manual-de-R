...
\chapter{Verosimilitud}\label{verosimilitud}
...
\begin{figure}[htbp]
\centering
\includegraphics{Manual_de_R_files/figure-latex/unnamed-chunk-234-1.pdf}
\caption{\label{fig:unnamed-chunk-234}Perfil de la función f(x).}
\end{figure}
