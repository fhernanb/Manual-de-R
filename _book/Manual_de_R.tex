...
\subsection{Almacenamiento de información en
Excel}\label{almacenamiento-de-informacion-en-excel}
...
\subsection{Almacenamiento de información en bloc de
notas}\label{almacenamiento-de-informacion-en-bloc-de-notas}
...
{\centering \includegraphics[width=2.77in]{images/bloc1} 
...
{\centering \includegraphics[width=2.79in]{images/bloc2} 
...
\begin{figure}[htbp]
\centering
\includegraphics{Manual_de_R_files/figure-latex/unnamed-chunk-87-1.pdf}
\caption{\label{fig:unnamed-chunk-87}Perfil de la función f(x).}
\end{figure}
