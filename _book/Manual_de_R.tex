...
\section{\texorpdfstring{Tipos de funciones disponibles para
distribuciones discretas
\index{distribuciones discretas}}{Tipos de funciones disponibles para distribuciones discretas }}\label{tipos-de-funciones-disponibles-para-distribuciones-discretas}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{pxxx}\NormalTok{(q, ...)  }\CommentTok{# Probability mass function, f(x)}
\KeywordTok{dxxx}\NormalTok{(x, ...)  }\CommentTok{# Cumulative distribution function, F(x)}
\KeywordTok{qxxx}\NormalTok{(p, ...)  }\CommentTok{# Quantile for P(X <= q) = p}
\KeywordTok{rxxx}\NormalTok{(n, ...)  }\CommentTok{# Random values generator}
\end{Highlighting}
\end{Shaded}
...
Combinando las funciones y los nombres se tiene un total de 20
...
\subsection*{Ejemplo distribución
binomial}\label{ejemplo-distribucion-binomial}
...
\NormalTok{m  }\CommentTok{# Para ver lo que hay dentro de m1}
\end{Highlighting}
\end{Shaded}
...
\subsection*{Ejemplo distribución
geométrica}\label{ejemplo-distribucion-geometrica}
...
\subsection*{Ejemplo distribución binomial
negativa}\label{ejemplo-distribucion-binomial-negativa}
\addcontentsline{toc}{subsection}{Ejemplo distribución binomial
negativa}
...
\subsection*{Ejemplo distribución
hipergeométrica}\label{ejemplo-distribucion-hipergeometrica}
...
\subsection*{Ejemplo distribución
Poisson}\label{ejemplo-distribucion-poisson}
...
\[\lambda=\frac{50 \quad errores}{libro}=\frac{0.2 \quad errores}{página}\]
...
\begin{figure}[htbp]
\centering
\includegraphics{Manual_de_R_files/figure-latex/unnamed-chunk-183-1.pdf}
\caption{\label{fig:unnamed-chunk-183}Perfil de la función f(x).}
\end{figure}
