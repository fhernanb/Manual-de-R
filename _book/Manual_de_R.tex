...
investigadores que nos han retroalimentado con comentarios valiosos para
...
\section{\texorpdfstring{Cuantiles \index{cuantiles}
\index{quantile}}{Cuantiles  }}\label{cuantiles}
...
\begin{figure}[htbp]
\centering
\includegraphics{Manual_de_R_files/figure-latex/unnamed-chunk-49-1.pdf}
\caption{\label{fig:unnamed-chunk-49}Perfil de la función f(x).}
\end{figure}
