...
\begin{verbatim}
## Warning: package 'corrplot' was built under R version
## 3.4.4
\end{verbatim}
...
##     GB2    BCTo  exGAUS   LOGNO      IG     EXP 
##   470.0   470.4   471.2   474.6   483.9   494.1 
## PARETO2  IGAMMA 
##   496.1   504.2
\end{verbatim}
...
\StringTok{hist(hombres$altura, freq=TRUE,}
\StringTok{     main='}\NormalTok{Histograma para la altura de hombres}\StringTok{',}
\StringTok{     xlab='}\KeywordTok{Altura}\NormalTok{ (cm)}\StringTok{',}
\StringTok{     ylab='}\NormalTok{Frecuencia}\StringTok{')}
\end{Highlighting}
\end{Shaded}
...
\StringTok{hist(hombres$altura, las=1, xlab='}\NormalTok{Altura}\StringTok{', ylab='}\NormalTok{Frecuencia}\StringTok{',}
\StringTok{     main='}\NormalTok{Histograma para la altura de hombres}\StringTok{')}

\StringTok{qqPlot(mujeres$altura, pch=19, las=1, main='}\NormalTok{QQplot}\StringTok{',}
\StringTok{       xlab='}\NormalTok{Cuantiles teóricos', }\DataTypeTok{ylab=}\StringTok{'Cuantiles muestrales'}\NormalTok{)}
...
\KeywordTok{qqPlot}\NormalTok{(Diferencia, }\DataTypeTok{pch=}\DecValTok{19}\NormalTok{, }\DataTypeTok{main=}\StringTok{'QQplot para Diferencias'}\NormalTok{, }\DataTypeTok{las=}\DecValTok{1}\NormalTok{, }
       \DataTypeTok{xlab=}\StringTok{'Cuantiles teóricos', ylab='}\NormalTok{Cuantiles muestrales}\StringTok{')}
\StringTok{plot(density(Diferencia), main='}\NormalTok{Densidad para Diferencias}\StringTok{', las=1,}
\StringTok{     xlab='}\NormalTok{Diferencia de tiempo}\StringTok{', ylab='}\NormalTok{Densidad}\StringTok{')}
\end{Highlighting}
\end{Shaded}
...
\index{prueba de hipótesis}}{Prueba de hipótesis. }}\label{prueba-de-hipotesis.}
...
Anderson-Darling por medio de la función \texttt{ad.test} como se
muestra a continuación.
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{pnorm}\NormalTok{(}\DataTypeTok{q=}\NormalTok{z, }\DataTypeTok{lower.tail=}\OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
Para realizar la prueba \(\Chi^2\) de Pearson se puede usar la función
...
\textbf{T}1: 76, 85, 74, 78, 82, 75, 82.
