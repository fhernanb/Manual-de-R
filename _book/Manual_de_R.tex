...
\item
  la varianza,
\item
  la diferencia de medias para muestras independientes y dependientes (o
  pareadas),
\item
...
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{))}
\KeywordTok{require}\NormalTok{(car)  }\CommentTok{# Debe instalar antes el paquete car}
\KeywordTok{qqPlot}\NormalTok{(hombres$altura, }\DataTypeTok{pch=}\DecValTok{19}\NormalTok{, }\DataTypeTok{las=}\DecValTok{1}\NormalTok{, }\DataTypeTok{main=}\StringTok{'QQplot'}\NormalTok{,}
       \DataTypeTok{xlab=}\StringTok{'Cuantiles teóricos'}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{'Cuantiles muestrales'}\NormalTok{)}
\KeywordTok{hist}\NormalTok{(hombres$altura, }\DataTypeTok{las=}\DecValTok{1}\NormalTok{, }\DataTypeTok{xlab=}\StringTok{'Altura'}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{'Frecuencia'}\NormalTok{,}
     \DataTypeTok{main=}\StringTok{'Histograma para la altura de hombres'}\NormalTok{)}

\KeywordTok{qqPlot}\NormalTok{(mujeres$altura, }\DataTypeTok{pch=}\DecValTok{19}\NormalTok{, }\DataTypeTok{las=}\DecValTok{1}\NormalTok{, }\DataTypeTok{main=}\StringTok{'QQplot'}\NormalTok{,}
       \DataTypeTok{xlab=}\StringTok{'Cuantiles teóricos'}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{'Cuantiles muestrales'}\NormalTok{)}
\KeywordTok{hist}\NormalTok{(mujeres$altura, }\DataTypeTok{las=}\DecValTok{1}\NormalTok{, }\DataTypeTok{xlab=}\StringTok{'Altura'}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{'Frecuencia'}\NormalTok{,}
...
de menos de 30 grados luego del cambio difiere de lo que era antes del
...
Para construir el intervalo de confianza, primero se crean dos
