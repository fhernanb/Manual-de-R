...
Construir tablas de frecuencias para variables cuantitativas es muy
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{hist}\NormalTok{(x, }\DataTypeTok{breaks=}\StringTok{'Sturges'}\NormalTok{, }\DataTypeTok{include.lowest=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{right=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{plot=}\OtherTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\item
  ...
  abiertos a derecha \([lim_{inf}, lim_{sup})\).
\item
...
\begin{verbatim}
## $breaks
## [1] 150 155 160 165 170 175 180 185
## 
## $counts
## [1]  1  6 15 67 82 27  2
## 
## $density
## [1] 0.001 0.006 0.015 0.067 0.082 0.027 0.002
## 
## $mids
...
intervalos y en en elemento \texttt{counts} están las frecuencias de
...
\begin{figure}[htbp]
\centering
\includegraphics{Manual_de_R_files/figure-latex/unnamed-chunk-113-1.pdf}
\caption{\label{fig:unnamed-chunk-113}Perfil de la función f(x).}
\end{figure}
