...
40 \(gramos^2\) o menos. ¿Está el proceso llenando bolsas conforme lo
dice la envoltura? Use un nivel de significancia del 5\%.
...
\KeywordTok{Var.test}\NormalTok{(}\DataTypeTok{x=}\NormalTok{contenido, }\DataTypeTok{alternative=}\StringTok{'greater'}\NormalTok{, }\DataTypeTok{null.value=}\DecValTok{40}\NormalTok{, }\DataTypeTok{conf.level=}\FloatTok{0.95}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
