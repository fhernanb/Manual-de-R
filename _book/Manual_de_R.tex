...
\textbf{bookdown}\index{bookdown} \citep{R-bookdown}.
...
\begin{verbatim}
##                precio  mt2 alcobas banos
## precio           1.00 0.86    0.19  0.63
## mt2              0.86 1.00    0.31  0.67
## alcobas          0.19 0.31    1.00  0.35
## banos            0.63 0.67    0.35  1.00
## administracion   0.75 0.77    0.16  0.55
## avaluo           0.79 0.75    0.15  0.53
##                administracion avaluo
## precio                   0.75   0.79
## mt2                      0.77   0.75
## alcobas                  0.16   0.15
## banos                    0.55   0.53
## administracion           1.00   0.70
## avaluo                   0.70   1.00
\end{verbatim}

El anterior resultado representa la matriz de correlaciones, se observa
que la mayor correlación corresponde a las variables precio y área del
apartamento. Es posible representar la matriz \texttt{M} de
correlaciones por medio de una figura, a continuación el código para
...
\KeywordTok{corrplot}\NormalTok{(M, }\DataTypeTok{method=}\StringTok{'ellipse'}\NormalTok{, }\DataTypeTok{type=}\StringTok{'upper'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
de correlación. De esta figura es muy fácil determinar las mayores
correlaciones debido al color y forma de la elipse. La elipse asociada a
precio y área tiene la mayor tonalidad azul que significa correlación
positiva.
...
\begin{figure}[htbp]
\centering
\includegraphics{Manual_de_R_files/figure-latex/unnamed-chunk-134-1.pdf}
\caption{\label{fig:unnamed-chunk-134}Perfil de la función f(x).}
\end{figure}
