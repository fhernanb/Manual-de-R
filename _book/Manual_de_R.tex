...
\texttt{c} dentro una matriz se usan corchetes \texttt{{[}f,\ c{]}} y
dentro el número de fila y número de columna que nos interesan.
\EndKnitrBlock{rmdnote}
...
\begin{figure}[htbp]
\centering
\includegraphics{Manual_de_R_files/figure-latex/unnamed-chunk-146-1.pdf}
\caption{\label{fig:unnamed-chunk-146}Perfil de la función f(x).}
\end{figure}
