...
le indica a \proglang{R} dónde debe buscar el archivo, note que se debe
usar el símbolo \texttt{/} para que sea un dirección válida.
...
\begin{figure}[htbp]
\centering
\includegraphics{Manual_de_R_files/figure-latex/unnamed-chunk-92-1.pdf}
\caption{\label{fig:unnamed-chunk-92}Perfil de la función f(x).}
\end{figure}
