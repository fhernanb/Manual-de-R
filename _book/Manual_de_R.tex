...
1- Construya una función que reciba dos números reales y que diga cuál
...
## 
## $density
## [1] 0.001 0.006 0.015 0.068 0.082 0.027 0.001
## 
## $mids
...
\begin{figure}[htbp]
\centering
\includegraphics{Manual_de_R_files/figure-latex/unnamed-chunk-123-1.pdf}
\caption{\label{fig:unnamed-chunk-123}Perfil de la función f(x).}
\end{figure}
