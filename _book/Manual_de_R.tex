...
\section{\texorpdfstring{¿Qué es una función? \index{función}
...
\begin{figure}[htbp]
\centering
\includegraphics{Manual_de_R_files/figure-latex/unnamed-chunk-74-1.pdf}
\caption{\label{fig:unnamed-chunk-74}Perfil de la función f(x).}
\end{figure}
