...
\section{\texorpdfstring{¿Qué es una función de R? \index{función}
\index{function}}{¿Qué es una función de R?  }}\label{que-es-una-funcion-de-r}
...
\begin{Shaded}
\begin{Highlighting}[]
\DecValTok{7} \OperatorTok{%/%}\StringTok{ }\DecValTok{3}  \CommentTok{# Para saber las veces que cabe 3 en 7}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\DecValTok{7} \OperatorTok{%%}\StringTok{ }\DecValTok{3}  \CommentTok{# Para saber el residuo al dividir 7 entre 3}
\end{Highlighting}
\end{Shaded}
...
Retome el marco de datos \texttt{mimarco} construído en la sección 2.4 y
use una prueba lógica para extraer la información de las personas que
tienen una edad superior o igual a 15 años.

Inicialmente vamos a construir nuevamente el objeto \texttt{mimarco} de
la sección 2.4 usando el siguiente código.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mimarco[mimarco}\OperatorTok{$}\NormalTok{edad }\OperatorTok{>=}\StringTok{ }\DecValTok{15}\NormalTok{, ]}
\end{Highlighting}
\end{Shaded}
...
Retome el marco de datos \texttt{mimarco} construído en la sección 2.4 y
use una prueba lógica para extraer la información de las personas que
tienen una edad superior o igual a 15 años y que practican deporte.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mimarco[mimarco}\OperatorTok{$}\NormalTok{edad }\OperatorTok{>=}\StringTok{ }\DecValTok{15} \OperatorTok{&}\StringTok{ }\NormalTok{mimarco}\OperatorTok{$}\NormalTok{deporte }\OperatorTok{==}\StringTok{ }\OtherTok{TRUE}\NormalTok{, ]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{5}\NormalTok{, }\DecValTok{3}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{8}\NormalTok{, }\OperatorTok{-}\DecValTok{4}\NormalTok{, }\DecValTok{1}\NormalTok{)}

\KeywordTok{ifelse}\NormalTok{(x }\OperatorTok{%%}\StringTok{ }\DecValTok{2} \OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{, }\StringTok{'Es par'}\NormalTok{, }\StringTok{'Es impar'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\section{\texorpdfstring{Función en R
...
\NormalTok{url <-}\StringTok{ 'https://raw.githubusercontent.com/fhernanb/datos/master/aptos2015'}
\NormalTok{datos <-}\StringTok{ }\KeywordTok{read.table}\NormalTok{(}\DataTypeTok{file=}\NormalTok{url, }\DataTypeTok{header=}\NormalTok{T)}
\KeywordTok{cor}\NormalTok{(}\DataTypeTok{x=}\NormalTok{datos}\OperatorTok{$}\NormalTok{mt2, }\DataTypeTok{y=}\NormalTok{datos}\OperatorTok{$}\NormalTok{precio)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{cor}\NormalTok{(}\DataTypeTok{x=}\NormalTok{datos}\OperatorTok{$}\NormalTok{mt2, }\DataTypeTok{y=}\NormalTok{datos}\OperatorTok{$}\NormalTok{precio, }\DataTypeTok{method=}\StringTok{'pearson'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{cor}\NormalTok{(}\DataTypeTok{x=}\NormalTok{datos}\OperatorTok{$}\NormalTok{mt2, }\DataTypeTok{y=}\NormalTok{datos}\OperatorTok{$}\NormalTok{precio, }\DataTypeTok{method=}\StringTok{'kendall'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{cor}\NormalTok{(}\DataTypeTok{x=}\NormalTok{datos}\OperatorTok{$}\NormalTok{mt2, }\DataTypeTok{y=}\NormalTok{datos}\OperatorTok{$}\NormalTok{precio, }\DataTypeTok{method=}\StringTok{'spearman'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
discretas
\index{distribucionecs discretas}}{Funciones disponibles para distribuciones discretas }}\label{funciones-disponibles-para-distribuciones-discretas}
...
El cangrejo de herradura hembra se caracteriza porque su caparazón se
...
\NormalTok{t1 <-}\StringTok{ }\KeywordTok{prop.table}\NormalTok{(}\KeywordTok{table}\NormalTok{(crab}\OperatorTok{$}\NormalTok{Sa))}
\NormalTok{t1}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{F <-}\StringTok{ }\KeywordTok{ecdf}\NormalTok{(crab}\OperatorTok{$}\NormalTok{Sa)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{grupo <-}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(crab}\OperatorTok{$}\NormalTok{Wt }\OperatorTok{<=}\StringTok{ }\KeywordTok{median}\NormalTok{(crab}\OperatorTok{$}\NormalTok{Wt), }\StringTok{'Grupo 1'}\NormalTok{, }\StringTok{'Grupo 2'}\NormalTok{)}
\NormalTok{x <-}\StringTok{ }\KeywordTok{split}\NormalTok{(}\DataTypeTok{x=}\NormalTok{crab}\OperatorTok{$}\NormalTok{Sa, }\DataTypeTok{f=}\NormalTok{grupo)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{plot}\NormalTok{(}\KeywordTok{density}\NormalTok{(crab}\OperatorTok{$}\NormalTok{W), }\DataTypeTok{main=}\StringTok{''}\NormalTok{, }\DataTypeTok{lwd=}\DecValTok{5}\NormalTok{, }\DataTypeTok{las=}\DecValTok{1}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{F <-}\StringTok{ }\KeywordTok{ecdf}\NormalTok{(crab}\OperatorTok{$}\NormalTok{W)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pesos <-}\StringTok{ }\KeywordTok{split}\NormalTok{(}\DataTypeTok{x=}\NormalTok{crab}\OperatorTok{$}\NormalTok{W, }\DataTypeTok{f=}\NormalTok{crab}\OperatorTok{$}\NormalTok{C)}
...
\NormalTok{crab}\OperatorTok{$}\NormalTok{Color <-}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(crab}\OperatorTok{$}\NormalTok{C)  }\CommentTok{# Para convertir en factor}

\KeywordTok{ggplot}\NormalTok{(crab, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{W)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_density}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{group=}\NormalTok{Color, }\DataTypeTok{fill=}\NormalTok{Color), }\DataTypeTok{alpha=}\FloatTok{0.3}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{xlim}\NormalTok{(}\DecValTok{18}\NormalTok{, }\DecValTok{34}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Peso (Kg)"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Densidad"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
desconocida \(\theta\), la verosimilitud \(L(\theta)\) es la
probabilidad de los datos observados \(x\) como una función de
\(\theta\) \citep{pawitan_2013}. Si la variable de interés es discreta
se usa la probabilidad y si es continua se usa la densidad para obtener
la verosimilitud.
\EndKnitrBlock{rmdnote}

La función de verosimilitud para un vector de parámetros
\(\boldsymbol{\Theta}\) dada una muestra aleatoria \(\boldsymbol{x}\)
con una distribución asumida se define usualmente como:
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{modelos}\OperatorTok{$}\NormalTok{fits}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{modelos}\OperatorTok{$}\NormalTok{mu}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{modelos}\OperatorTok{$}\NormalTok{sigma}
\end{Highlighting}
\end{Shaded}
...
incertidumbre sobre el parámetro \(\theta\) \citep{pawitan_2013}. En
particular la varianza del estimador de máxima verosimilitud está dada
por
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{c}\NormalTok{(res2}\OperatorTok{$}\NormalTok{par[}\DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{], }\KeywordTok{exp}\NormalTok{(res2}\OperatorTok{$}\NormalTok{par[}\DecValTok{3}\NormalTok{]))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pesos <-}\StringTok{ }\KeywordTok{split}\NormalTok{(datos}\OperatorTok{$}\NormalTok{peso, datos}\OperatorTok{$}\NormalTok{sexo)}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(}\KeywordTok{density}\NormalTok{(pesos}\OperatorTok{$}\NormalTok{Hombre), }\DataTypeTok{lwd=}\DecValTok{3}\NormalTok{, }\DataTypeTok{col=}\StringTok{'blue'}\NormalTok{,}
     ...
     \DataTypeTok{xlab=}\StringTok{'Peso (kg)'}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{'Densidad'}\NormalTok{)}
\KeywordTok{lines}\NormalTok{(}\KeywordTok{density}\NormalTok{(pesos}\OperatorTok{$}\NormalTok{Mujer), }\DataTypeTok{lwd=}\DecValTok{3}\NormalTok{, }\DataTypeTok{col=}\StringTok{'deeppink'}\NormalTok{)}
...
\begin{Highlighting}[]
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{))}
\KeywordTok{qqnorm}\NormalTok{(pesos}\OperatorTok{$}\NormalTok{Hombre, }\DataTypeTok{pch=}\DecValTok{20}\NormalTok{,}
       \DataTypeTok{main=}\StringTok{'QQplot para peso de hombres'}\NormalTok{)}
\KeywordTok{qqline}\NormalTok{(pesos}\OperatorTok{$}\NormalTok{Hombre)}

\KeywordTok{qqnorm}\NormalTok{(pesos}\OperatorTok{$}\NormalTok{Mujer, }\DataTypeTok{pch=}\DecValTok{20}\NormalTok{,}
       \DataTypeTok{main=}\StringTok{'QQplot para peso de mujeres'}\NormalTok{)}
\KeywordTok{qqline}\NormalTok{(pesos}\OperatorTok{$}\NormalTok{Mujer)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{))}
\KeywordTok{qqPlot}\NormalTok{(pesos}\OperatorTok{$}\NormalTok{Hombre, }\DataTypeTok{pch=}\DecValTok{20}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{'Peso (Kg)'}\NormalTok{,}
       \DataTypeTok{main=}\StringTok{'QQplot para peso de hombres'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{qqPlot}\NormalTok{(pesos}\OperatorTok{$}\NormalTok{Mujer, }\DataTypeTok{pch=}\DecValTok{20}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{'Peso (Kg)'}\NormalTok{,}
       \DataTypeTok{main=}\StringTok{'QQplot para peso de mujeres'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{url <-}\StringTok{ 'https://raw.githubusercontent.com/fhernanb/datos/master/medidas_cuerpo'}
\NormalTok{datos <-}\StringTok{ }\KeywordTok{read.table}\NormalTok{(}\DataTypeTok{file=}\NormalTok{url, }\DataTypeTok{header=}\NormalTok{T)}
\NormalTok{hombres <-}\StringTok{ }\NormalTok{datos[datos}\OperatorTok{$}\NormalTok{sexo}\OperatorTok{==}\StringTok{"Hombre"}\NormalTok{, ]}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{))}
\KeywordTok{require}\NormalTok{(car)  }\CommentTok{# Debe instalar antes el paquete car}
\KeywordTok{qqPlot}\NormalTok{(hombres}\OperatorTok{$}\NormalTok{altura, }\DataTypeTok{pch=}\DecValTok{19}\NormalTok{,}
       \DataTypeTok{main=}\StringTok{'QQplot para la altura de hombres'}\NormalTok{,}
       \DataTypeTok{xlab=}\StringTok{'Cuantiles teóricos',}
\StringTok{       ylab='}\NormalTok{Cuantiles muestrales}\StringTok{')}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{hist}\NormalTok{(hombres}\OperatorTok{$}\NormalTok{altura, }\DataTypeTok{freq=}\OtherTok{TRUE}\NormalTok{,}
     \DataTypeTok{main=}\StringTok{'Histograma para la altura de hombres'}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{t.test}\NormalTok{(}\DataTypeTok{x=}\NormalTok{hombres}\OperatorTok{$}\NormalTok{altura, }\DataTypeTok{conf.level=}\FloatTok{0.90}\NormalTok{)}\OperatorTok{$}\NormalTok{conf.int}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{datos <-}\StringTok{ }\KeywordTok{read.table}\NormalTok{(}\DataTypeTok{file=}\NormalTok{url, }\DataTypeTok{header=}\NormalTok{T)}
\NormalTok{hombres <-}\StringTok{ }\NormalTok{datos[datos}\OperatorTok{$}\NormalTok{sexo}\OperatorTok{==}\StringTok{"Hombre"}\NormalTok{, ]}
\NormalTok{mujeres <-}\StringTok{ }\NormalTok{datos[datos}\OperatorTok{$}\NormalTok{sexo}\OperatorTok{==}\StringTok{"Mujer"}\NormalTok{, ]}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mfrow=}\KeywordTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{))}
\KeywordTok{require}\NormalTok{(car)  }\CommentTok{# Debe instalar antes el paquete car}
\KeywordTok{qqPlot}\NormalTok{(hombres}\OperatorTok{$}\NormalTok{altura, }\DataTypeTok{pch=}\DecValTok{19}\NormalTok{, }\DataTypeTok{las=}\DecValTok{1}\NormalTok{, }\DataTypeTok{main=}\StringTok{'QQplot'}\NormalTok{,}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{hist}\NormalTok{(hombres}\OperatorTok{$}\NormalTok{altura, }\DataTypeTok{las=}\DecValTok{1}\NormalTok{, }\DataTypeTok{xlab=}\StringTok{'Altura'}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{'Frecuencia'}\NormalTok{,}
     \DataTypeTok{main=}\StringTok{'Histograma para la altura de hombres'}\NormalTok{)}

\KeywordTok{qqPlot}\NormalTok{(mujeres}\OperatorTok{$}\NormalTok{altura, }\DataTypeTok{pch=}\DecValTok{19}\NormalTok{, }\DataTypeTok{las=}\DecValTok{1}\NormalTok{, }\DataTypeTok{main=}\StringTok{'QQplot'}\NormalTok{,}
       \DataTypeTok{xlab=}\StringTok{'Cuantiles teóricos', ylab='}\NormalTok{Cuantiles muestrales}\StringTok{')}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{hist}\NormalTok{(mujeres}\OperatorTok{$}\NormalTok{altura, }\DataTypeTok{las=}\DecValTok{1}\NormalTok{, }\DataTypeTok{xlab=}\StringTok{'Altura'}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{'Frecuencia'}\NormalTok{,}
     \DataTypeTok{main=}\StringTok{'Histograma para la altura de mujeres'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{t.test}\NormalTok{(}\DataTypeTok{x=}\NormalTok{hombres}\OperatorTok{$}\NormalTok{altura, }\DataTypeTok{y=}\NormalTok{mujeres}\OperatorTok{$}\NormalTok{altura,}
...
la elevación del brazo fue de menos de 30 grados. Las dos mediciones de
...
de menos de 30 grados luego del cambio difiere de lo que era antes?
Calcular un intervalo de confianza del \(95\%\) para responder la
pregunta.
...
Para construir el intervalo de confianza primero se crean dos vectores
con los datos y se nombran \texttt{Antes} y \texttt{Despues}, luego se
calcula la diferencia y se aloja en el vector \texttt{Diferencia}, como
sigue a continuación:
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{t.test}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Antes, }\DataTypeTok{y=}\NormalTok{Despues, }\DataTypeTok{paired=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{conf.level=}\FloatTok{0.95}\NormalTok{)}\OperatorTok{$}\NormalTok{conf.int}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x <-}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(}\DecValTok{50}\NormalTok{, }\DataTypeTok{mean =} \DecValTok{18}\NormalTok{, }\DataTypeTok{sd =}\DecValTok{3}\NormalTok{)}
\KeywordTok{t.test}\NormalTok{(x, }\DataTypeTok{alternative =} \StringTok{"greater"}\NormalTok{, }\DataTypeTok{conf.level =} \FloatTok{0.90}\NormalTok{)}\OperatorTok{$}\NormalTok{conf.int}
\end{Highlighting}
\end{Shaded}
...
función \texttt{var.test} del paquete \textbf{stests}
\citep{R-usefultools} disponible en el repositorio
\href{https://github.com/}{GitHub}.

Para instalar el paquete \textbf{stests} desde GitHub se debe copiar el
siguiente código en la consola de R:
...
\NormalTok{devtools}\OperatorTok{::}\KeywordTok{install_github}\NormalTok{(}\StringTok{'fhernanb/stests'}\NormalTok{, }\DataTypeTok{force=}\OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

Una vez instalado el paquete \textbf{stests} se puede usar la función
\texttt{var.test}, la cual es una generalización de la función
\texttt{var.test} del paquete \textbf{stats} y por esa razón aparece el
siguiente mensaje en la consola cuando se invoca el paquete.

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(stests)}
\NormalTok{## }
...
Si usted desea usar \texttt{var.test} del paquete \textbf{stats} o
\texttt{var.test} del paquete \textbf{stests}, puede invocar las
funciones explícitamente así:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{stats}\OperatorTok{::}\KeywordTok{var.test}\NormalTok{()   }\CommentTok{# Para usar la fución del paquete stats}
\NormalTok{stests}\OperatorTok{::}\KeywordTok{var.test}\NormalTok{()  }\CommentTok{# Para usar la fución del paquete stests}
\end{Highlighting}
\end{Shaded}

\BeginKnitrBlock{rmdnote}
Recuerde que: - \texttt{stats::var.test()} sólo sirve para 1 población.
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{require}\NormalTok{(stests)  }\CommentTok{# Para cargar el paquete}
\NormalTok{res <-}\StringTok{ }\KeywordTok{var.test}\NormalTok{(}\DataTypeTok{x=}\NormalTok{hombres}\OperatorTok{$}\NormalTok{altura, }\DataTypeTok{conf.level=}\FloatTok{0.98}\NormalTok{)}
\NormalTok{res}\OperatorTok{$}\NormalTok{conf.int}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{var.test}\NormalTok{(}\DataTypeTok{x=}\NormalTok{hombres}\OperatorTok{$}\NormalTok{altura, }\DataTypeTok{y=}\NormalTok{mujeres}\OperatorTok{$}\NormalTok{altura,}
         \DataTypeTok{conf.level=}\FloatTok{0.95}\NormalTok{)}\OperatorTok{$}\NormalTok{conf.int}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{prop.test}\NormalTok{(}\DataTypeTok{x=}\DecValTok{275}\NormalTok{, }\DataTypeTok{n=}\DecValTok{500}\NormalTok{, }\DataTypeTok{conf.level=}\FloatTok{0.90}\NormalTok{)}\OperatorTok{$}\NormalTok{conf.int}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{prop.test}\NormalTok{(}\DataTypeTok{x=}\KeywordTok{c}\NormalTok{(}\DecValTok{75}\NormalTok{, }\DecValTok{80}\NormalTok{), }\DataTypeTok{n=}\KeywordTok{c}\NormalTok{(}\DecValTok{1500}\NormalTok{, }\DecValTok{2000}\NormalTok{), }\DataTypeTok{conf.level=}\FloatTok{0.90}\NormalTok{)}\OperatorTok{$}\NormalTok{conf.int}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{require}\NormalTok{(nortest)  }\CommentTok{# Se debe tener instalado}
\KeywordTok{lillie.test}\NormalTok{(T1)}\OperatorTok{$}\NormalTok{p.value}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{lillie.test}\NormalTok{(T2)}\OperatorTok{$}\NormalTok{p.value}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{var.test}\NormalTok{(T1, T2, }\DataTypeTok{null.value=}\DecValTok{1}\NormalTok{, }\DataTypeTok{alternative=}\StringTok{"two.sided"}\NormalTok{,}
         \DataTypeTok{conf.level=}\FloatTok{0.95}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{require}\NormalTok{(nortest)  }\CommentTok{# Se debe tener instalado}
\KeywordTok{lillie.test}\NormalTok{(urb)}\OperatorTok{$}\NormalTok{p.value}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{lillie.test}\NormalTok{(rur)}\OperatorTok{$}\NormalTok{p.value}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{var.test}\NormalTok{(urb, rur, }\DataTypeTok{null.value=}\DecValTok{1}\NormalTok{, }\DataTypeTok{alternative=}\StringTok{"two.sided"}\NormalTok{,}
         \DataTypeTok{conf.level=}\FloatTok{0.95}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{constant <-}\StringTok{ }\OperatorTok{-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(}\KeywordTok{hessian}\NormalTok{(fun, res}\OperatorTok{$}\NormalTok{maximum))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{fun}\NormalTok{(res}\OperatorTok{$}\NormalTok{maximum) }\OperatorTok{*}\StringTok{ }\KeywordTok{sqrt}\NormalTok{(}\DecValTok{2}\OperatorTok{*}\NormalTok{pi}\OperatorTok{/}\NormalTok{constant)}
\end{Highlighting}
\end{Shaded}
