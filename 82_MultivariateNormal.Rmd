...
En estadística univariada, la distribución $\chi^2$ juega un papel importante en la inferencia sobre $\sigma^2$ en una $N(\mu, \sigma^2)$. La distribución de Wishart es una generalización multivariada de la distribución univariada $\chi^2$ y desempeña un papel análogo en las estadísticas multivariadas.
