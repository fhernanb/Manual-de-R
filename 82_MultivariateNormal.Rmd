...
Apliquemos ahora una prueba para estudiar $H_0:$ las $D^2$ tienen distribución $\chi_p$ versus $H_1:$ las $D^2$ NO provienen de una distribución $\chi_p$.

Primero hagamos un histograma para $D^2$ (con $k=5$ intervalos) y luego le superponemos la densidad de $\chi_p$.
...
Ahora vamos a calcular las probabilidades esperadas de cada cajón asumiendo que $H_0$ es verdadera, es decir, que las distancias se distribuyen $\chi_p$.
...
y luego aplicar la prueba `chisq.test` para determinar si las distancias $D^2$ siguen una distribución $\chi_p$. Repetir esta operación 100 veces para cada uno de los valores $n$ de la siguiente tabla. Use $k=10$ intervalos.
